...
export const metadata: Metadata = {
  title: "Spotify 播放清單匯出教學 | 3 步驟備份歌單到 CSV",
  description:
    "詳細教學：如何免費匯出 Spotify 播放清單到 CSV/Excel。支援喜歡的歌曲、私人歌單，3 步驟完成備份，可轉移 Apple Music、YouTube Music。含常見問題 FAQ。",
  alternates: {
    canonical: "https://spotify-playlist-export-eight.vercel.app/tutorial",
  },
  openGraph: {
    title: "Spotify 播放清單匯出教學 | 3 步驟備份歌單到 CSV",
    description:
      "詳細教學：如何免費匯出 Spotify 播放清單到 CSV/Excel。支援喜歡的歌曲、私人歌單，3 步驟完成備份。",
    url: "https://spotify-playlist-export-eight.vercel.app/tutorial",
    type: "article",
  },
};
      ...
      <div className="min-h-screen bg-zinc-50 dark:bg-black">
        ...
        <main className="max-w-4xl mx-auto px-4 py-12">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-3 text-sm text-green-800 dark:text-green-200">
                      ✅ <strong>完成！</strong>
                      您的播放清單資料已成功匯出，可以用於備份、分析或轉移到其他音樂平台。
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-white dark:bg-zinc-900 rounded-xl p-6 border border-zinc-200 dark:border-zinc-800">
                ...
                <p className="text-sm text-zinc-600 dark:text-zinc-400">
                  定期匯出播放清單，避免因帳號問題或歌曲下架而遺失精心整理的歌單。CSV
                  檔案可永久保存在您的電腦或雲端。
                </p>
              </div>
              ...
              <div className="bg-white dark:bg-zinc-900 rounded-xl p-6 border border-zinc-200 dark:border-zinc-800">
                ...
                <p className="text-sm text-zinc-600 dark:text-zinc-400">
                  想換到 Apple Music 或 YouTube Music？匯出 CSV
                  後，使用 SongShift、TuneMyMusic
                  等第三方工具即可快速轉移歌單。
                </p>
              </div>
              ...
              <div className="bg-white dark:bg-zinc-900 rounded-xl p-6 border border-zinc-200 dark:border-zinc-800">
                ...
                <p className="text-sm text-zinc-600 dark:text-zinc-400">
                  用 Excel 或 Python
                  分析您的音樂品味：最常聽的藝人、專輯發行年份分布、歌曲時長統計等，深入了解自己的聽歌偏好。
                </p>
              </div>
          ...
          <section className="bg-gradient-to-br from-green-400 via-green-500 to-green-600 dark:from-green-900 dark:via-green-800 dark:to-black rounded-2xl p-8 md:p-12 text-center">
            ...
            <p className="text-green-50 mb-6 text-lg">完全免費、無廣告、3 步驟完成</p>
            <Link
              href="/"
